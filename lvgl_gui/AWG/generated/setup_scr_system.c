...
void setup_scr_system(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->system_btn1_label, "");
    ...
    lv_obj_set_style_border_color(ui->system_btn1, lv_color_hex(0x8cecb4), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->system_label_param8, lv_color_hex(0x85fffe), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->system_label_line1, 0, 34);
    ...
    lv_obj_set_style_bg_color(ui->system_label_line1, lv_color_hex(0x85fffe), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui->system_btn_menu1, 90, 35);

    //Write style for system_btn_menu1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->system_btn_menu1, 52, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->system_btn_menu1, lv_color_hex(0x85fffe), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->system_btn_menu2, 93, 1);
    lv_obj_set_size(ui->system_btn_menu2, 90, 35);

    //Write style for system_btn_menu2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->system_btn_menu2, 53, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->system_btn_menu2, lv_color_hex(0x85fffe), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->system_btn_menu3, 185, 1);
    lv_obj_set_size(ui->system_btn_menu3, 90, 35);
    ...
    lv_obj_set_style_bg_color(ui->system_btn_menu3, lv_color_hex(0x85fffe), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->system_btn_menu4_label, "  系统");
    ...
    lv_obj_set_pos(ui->system_btn_menu4, 277, 1);
    lv_obj_set_size(ui->system_btn_menu4, 90, 35);

    //Write style for system_btn_menu4, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->system_btn_menu4, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->system_btn_menu4, lv_color_hex(0x85fffe), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui->system_btn_menu4, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->system_label_param1, 5, 88);
    ...
    lv_obj_set_pos(ui->system_sw_oe, 103, 44);
    ...
    //Write codes system_sw_1
    ui->system_sw_1 = lv_switch_create(ui->system);
    lv_obj_set_pos(ui->system_sw_1, 270, 45);
    lv_obj_set_size(ui->system_sw_1, 60, 30);

    //Write style for system_sw_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->system_sw_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->system_sw_1, lv_color_hex(0x0c0d0a), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->system_sw_1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->system_sw_1, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->system_sw_1, 153, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->system_sw_1, lv_color_hex(0x30e37a), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->system_sw_1, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->system_sw_1, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->system_sw_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write style for system_sw_1, Part: LV_PART_INDICATOR, State: LV_STATE_CHECKED.
    lv_obj_set_style_bg_opa(ui->system_sw_1, 255, LV_PART_INDICATOR|LV_STATE_CHECKED);
    lv_obj_set_style_bg_color(ui->system_sw_1, lv_color_hex(0x267e48), LV_PART_INDICATOR|LV_STATE_CHECKED);
    lv_obj_set_style_bg_grad_dir(ui->system_sw_1, LV_GRAD_DIR_NONE, LV_PART_INDICATOR|LV_STATE_CHECKED);
    lv_obj_set_style_border_width(ui->system_sw_1, 0, LV_PART_INDICATOR|LV_STATE_CHECKED);

    //Write style for system_sw_1, Part: LV_PART_KNOB, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->system_sw_1, 255, LV_PART_KNOB|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->system_sw_1, lv_color_hex(0xe06105), LV_PART_KNOB|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->system_sw_1, LV_GRAD_DIR_NONE, LV_PART_KNOB|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->system_sw_1, 0, LV_PART_KNOB|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->system_sw_1, 10, LV_PART_KNOB|LV_STATE_DEFAULT);

    //Write codes system_label_1
    ui->system_label_1 = lv_label_create(ui->system);
    lv_label_set_text(ui->system_label_1, " 通道1输出");
    lv_label_set_long_mode(ui->system_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->system_label_1, 175, 50);
    lv_obj_set_size(ui->system_label_1, 95, 20);

    //Write style for system_label_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->system_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->system_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->system_label_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->system_label_1, &lv_font_ZiHunDaHei_18, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->system_label_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->system_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->system_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->system_label_1, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->system_label_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->system_label_1, lv_color_hex(0x0d0d0d), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->system_label_1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->system_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->system_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->system_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->system_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->system_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes system_dropdown_rom
    ui->system_dropdown_rom = lv_dropdown_create(ui->system);
    lv_dropdown_set_options(ui->system_dropdown_rom, "list1\nlist2\nlist3");
    ...
    lv_obj_set_style_text_font(ui->system_dropdown_rom, &lv_font_montserratMedium_14, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->system_dropdown_rom, &lv_font_montserratMedium_14, LV_PART_MAIN|LV_STATE_CHECKED);
    ...
    lv_obj_set_style_text_font(ui->system_dropdown_rom, &lv_font_montserratMedium_14, LV_PART_MAIN|LV_STATE_FOCUSED);
    ...
    lv_style_set_text_font(&style_system_dropdown_rom_extra_list_selected_checked, &lv_font_montserratMedium_14);
    ...
    lv_style_set_text_font(&style_system_dropdown_rom_extra_list_main_default, &lv_font_montserratMedium_14);
